...
function LocalStorageManager() {
  this.bestScoreKey     = "bestScoreFives";
  this.gameStateKey     = "gameStateFives";
  this.nextkey="nextFives";
  this.deckkey="deckFives";
  this.giantkey="giantFives";
...
LocalStorageManager.prototype.resetdeck=function(){
  var deck=[2,2,2,2,3,3,3,3,5,5,5,5];
...
LocalStorageManager.prototype.draw=function(nogiant){
  ...
  if(isgiant){
    ...
    if(maxtile>=80){//Skip giants if they can't spawn
      if(maxtile===80){
        this.setnext([10]);
      }else if(maxtile===160){
        this.setnext([10,20]);
